...
class BeforeLoginNC: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        /*if(FBSDKAccessToken.current() != nil) {
            ...
            print("[BeforeLoginNC] Login using FB")
            
            // Apabila user da log masuk guna fb
            // terus jadikan AfterLoginNC sebagai rootviewcontroller
        ...
        //}
        else */ if(getRememberData == true && getLoggedInData == true)
        {
