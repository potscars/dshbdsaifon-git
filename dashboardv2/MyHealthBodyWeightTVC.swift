...
class MyHealthBodyWeightTVC: UITableViewController {
    ...
    func populateData(data: NSDictionary) {
        ...
        for i in 0...getData.count - 1 {
            ...
            let bmiInDouble: Double = Double(extractedData.value(forKey: "WeightValue") as! String)!
            
            dataArrays.add(["MYHEALTH_BW_BMI":"\(extractedData.value(forKey: "BMI") as! String) mata",
                "MYHEALTH_BW_BMI_RAW":"\(extractedData.value(forKey: "BMI") as! String)",
                "MYHEALTH_BW_WEIGHT":"\(Int(bmiInDouble)) kg",
                "MYHEALTH_BW_WEIGHT_RAW":extractedData.value(forKey: "WeightValue") as! String,
                "MYHEALTH_BW_BONEMASS":"\(extractedData.value(forKey: "BoneValue") as! String)",
                "MYHEALTH_BW_FATWEIGHT":extractedData.value(forKey: "FatValue") as! String,
                "MYHEALTH_BW_LEANWEIGHT":extractedData.value(forKey: "LeanWeight") as! String,
                "MYHEALTH_BW_MUSCLEMASS":extractedData.value(forKey: "MuscaleValue") as! String,
                "MYHEALTH_BW_WATERWEIGHT":extractedData.value(forKey: "WaterValue") as! String,
                "MYHEALTH_BW_CHECKEDDATE":extractedData.value(forKey: "MdateTime") as! String
                ])
