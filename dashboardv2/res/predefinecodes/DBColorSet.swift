...
class DBColorSet: NSObject {
    ...
    // Color reference from RGB Slider (Xcode)
    static let dashboardMainColor: UIColor = UIColor.init(red: 0.00, green: 0.48, blue: 1.00, alpha: 1.0)
    static let dashboardMinorColor: UIColor = UIColor.init(red: 0.00, green: 0.9, blue: 1.00, alpha: 1.0)
    
    //MARK: - MyPlace Color
    
    static let myPlacePrimaryColor: UIColor = UIColor.init(red: 0/255, green: 150/255, blue: 136/255, alpha: 1)
    static let myPlaceDarkPrimaryColor: UIColor = UIColor.init(red: 0/255, green: 151/255, blue: 107/255, alpha: 1)
    
    
    // Color reference from Sip (macOS App). Color name is Dark Cerulean
    static let dashboardKBTertiaryColor: UIColor = UIColor.init(red: 0.07, green: 0.23, blue: 0.51, alpha: 1.0)
    ...
    static func loginColorSet() -> [Any] {
        ...
        let color1 = UIColor(red: 25.0/255.0, green: 181.0/255.0, blue: 254.0/255.0, alpha: 1.0).cgColor
        let color2 = UIColor(red: 44.0/255.0, green: 62.0/255.0, blue: 80.0/255.0, alpha: 1.0).cgColor
