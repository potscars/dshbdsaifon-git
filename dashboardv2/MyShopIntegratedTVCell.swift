...
class MyShopIntegratedTVCell: UITableViewCell {
    ...
    {        
        ZImages.getImageFromUrlSession(fromURL: "\(data.object(forKey: "MYSHOP_PROD_PHOTO_THUMB") as! String)", defaultImage: "ic_logodb", imageView: uiivMSITVCProdImage)
        //let image: UIImage = data.object(forKey: "MYSHOP_PROD_PHOTO_THUMB") as! UIImage
        //uiivMSITVCProdImage.image = image
        uilMSITVCProdName.text = "\(data.object(forKey: "MYSHOP_PROD_TITLE") as! String)"
        uilMSITVCProdViewed.text = "\(data.object(forKey: "MYSHOP_PROD_VIEWER_COUNT") as! String)"
        uilMSITVCProdComment.text = "\(data.object(forKey: "MYSHOP_PROD_COMMENT_COUNT") as! String)"
        uilMSITVCProdPrice.text = "RM \(data.object(forKey: "MYSHOP_PROD_PRICE") as! String)"
        cvMSITVCProdRating.rating = Double.init(data.object(forKey: "MYSHOP_PROD_RATING_COUNT") as! String)!
    }
    ...
    func updateProductDetailsProductPicture(data: NSArray, withViewController: UIViewController) {
        ...
        issMSITVCDetailsPicture.contentScaleMode = UIViewContentMode.scaleToFill
    ...
    func updateProductDetailsProductComment(data: NSDictionary) {
        ...
        cvMSITVCRatingCommentor.rating = Double.init(data.object(forKey: "rating") as! String)!
