...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var uibLVCReturnToLogin: UIButton!
    ...
    override func viewDidLoad() {
        ...
        uibLVCReturnToLogin.addTarget(self, action: #selector(returnToLogin(button:)), for: UIControlEvents.touchUpInside)
    ...
    @IBAction func loginAction(_ sender: UIButton) {
        ...
        if(dbDataAcquire != "PASSWORD") {
            ...
            if(DBWebServices.checkConnectionToDashboard(viewController: self) == true) { self.performSegue(withIdentifier: "DB_PROCESS_LOGIN", sender: self) }
    ...
    func getUserData(_ sender: UIButton) {
        ...
        else if(uitfLVCLoginField.text == "" && dbDataAcquire == "USERNAME")
        {
            ...
            ZGraphics.labelLayerFadeAnimation(labelView: uilLVCLoginLabel, labelTextToAnimate: DBStrings.DB_LOGIN_IC_LABEL_EN)
