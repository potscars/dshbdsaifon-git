...
class MyShopProductDetailsTVC: UITableViewController {
    ...
    @objc func populateData(data: NSDictionary) {
        ...
        moreDetailedData = ["MYSHOP_PROD_ID":nullCheckerReturnToString(string: notiWrap.value(forKey: "id") as? String),
                            "MYSHOP_PROD_TITLE":nullCheckerReturnToString(string: notiWrap.value(forKey: "title") as? String),
                            "MYSHOP_PROD_DESCRIPTION":nullCheckerReturnToString(string:notiWrap.value(forKey: "description") as? String),
                            "MYSHOP_PROD_RATING_COUNT":nullCheckerReturnToString(string:notiWrap.value(forKey: "rating_count") as? String),
                            "MYSHOP_PROD_VIEWER_COUNT":nullCheckerReturnToString(string:notiWrap.value(forKey: "viewer_count") as? String),
                            "MYSHOP_PROD_VIEWER_COUNT_WEEKLY":nullCheckerReturnToString(string:notiWrap.value(forKey: "viewer_count_by_week") as? String),
                            "MYSHOP_PROD_SEARCH_COUNT_WEEKLY":nullCheckerReturnToString(string:notiWrap.value(forKey: "search_count_by_week") as? String),
                            "MYSHOP_PROD_WEEK_VIEWER":nullCheckerReturnToString(string:notiWrap.value(forKey: "week_viewer") as? String),
                            "MYSHOP_PROD_COMMENT_COUNT":nullCheckerReturnToString(string:notiWrap.value(forKey: "comment_count") as? String),
                            "MYSHOP_PROD_PRICE":nullCheckerReturnToString(string:notiWrap.value(forKey: "price") as? String),
                            "MYSHOP_PROD_QUANTITY":nullCheckerReturnToString(string:notiWrap.value(forKey: "quantity") as? String),
                            "MYSHOP_PROD_SKU":nullCheckerReturnToString(string:notiWrap.value(forKey: "sku") as? String),
                            "MYSHOP_PROD_PER_ITEM_SHIPPING_ID":nullCheckerReturnToString(string:notiWrap.value(forKey: "per_item_shipping_id") as? String),
                            "MYSHOP_PROD_OPTION":nullCheckerReturnToString(string:notiWrap.value(forKey: "option") as? String),
                            "MYSHOP_PROD_DATE":nullCheckerReturnToString(string:notiWrap.value(forKey: "date") as? String),
                            "MYSHOP_PROD_TERM":nullCheckerReturnToString(string:notiWrap.value(forKey: "term") as? String),
                            "MYSHOP_PROD_UPDATE_DATE":nullCheckerReturnToString(string:notiWrap.value(forKey: "updated_at") as? String),
                            "MYSHOP_PROD_CREATED_DATE":nullCheckerReturnToString(string:notiWrap.value(forKey: "created_at") as? String),
                            "MYSHOP_PROD_PHOTO_THUMB":nullCheckerReturnToString(string:notiWrap.value(forKey: "url_photo_thumb") as? String),
                            "MYSHOP_PROD_PHOTO_LARGE":nullCheckerReturnToString(string:notiWrap.value(forKey: "url_photo_large") as? String),
